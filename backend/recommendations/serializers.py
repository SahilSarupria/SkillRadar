...
from .models import (
    LearningPlatform, Course, Skill, CourseRecommendation, 
    LearningPath, UserCourseProgress, AffiliateClick
)
...
class LearningPathSerializer(serializers.ModelSerializer):
    ...
    def get_progress_percentage(self, obj):
        ...
        try:
            progress = UserCourseProgress.objects.get(user=request.user, learning_path=obj)
